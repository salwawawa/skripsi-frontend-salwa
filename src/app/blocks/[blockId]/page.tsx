              ...
              <div className="border rounded-md overflow-hidden mb-4 shadow-sm hover:shadow-md transition-shadow">
                <div className="md:flex">
                  <div className="md:w-1/3 relative w-32 h-32 flex justify-center mx-auto">
                    <Image 
                      src={store.foto ? (store.foto.startsWith('https') ? store.foto : `https://sentratamansari.com/photos/${store.foto.startsWith('/') ? store.foto.slice(1) : store.foto}`) : '/assets/default-store.jpg'} 
                      alt={store.nama} 
                      fill 
